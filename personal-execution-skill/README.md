...
- Automation candidates are not added to manual todos. They are routed to `state/automation-candidates.md` with prompt, steps, expected artifacts, and acceptance criteria.
